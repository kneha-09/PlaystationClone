    ...
    <div>
            ...
            <div class="carousel-item" data-bs-interval="5000">
              ...
              <div class="carousel-caption d-none d-md-block banner-heading">
                ...
                <p>
                  ...
                  Plunder, while Warzone™ Ranked Play adds some healthy
                  competition
                </p>
                <button>Find out more</button>
              </div>
      ...
      <div className="image-gallery-slider">
        <div className="container-slider">
          <div className="box-slider">
            <img src="https://i.ibb.co/0p07BtZ/gallery-img1.webp" />
          </div>
          <div className="box-slider">
            <img src="https://i.ibb.co/QjYQG8v/gallery-img2.webp" />
          </div>
          <div className="box-slider">
            <img src="https://i.ibb.co/cDfZ7W0/gallery-img3.webp" />
          </div>
          <div className="box-slider">
            <img src="https://i.ibb.co/R72DFPk/gallery-img4.webp" />
          </div>
          <div className="box-slider">
            <img src="https://i.ibb.co/r22Nxgt/gallery-img5.webp" />
          </div>
        </div>
      </div>
      ...
      <div className="image-gallery">
        <div className="image-container">
          <div className="boxes">
            <img className="img1" src="https://i.ibb.co/NxcBHXP/4s-img1.webp" />
            <p>PS5 Console</p>
          </div>
          <div className="boxes">
            <img className="img2" src="https://i.ibb.co/tpG3yHS/4s-img2.webp" />
            <p>
          ...
          <div className="boxes">
            <img className="img4" src="https://i.ibb.co/9GT6t8G/4s-img4.webp" />
            <p>DualSense Edge</p>
          </div>
          <div className="boxes">
            <img id="img5" src="https://i.ibb.co/gjhw1Dm/4s-img5.webp" />
            <p>Media Remote</p>
          </div>
          <div className="boxes">
            <img id="img6" src="https://i.ibb.co/cw55nTC/4s-img6.webp" />
            <p>HD Camera</p>
          </div>
        </div>
      </div>
          ...
          <div className="poster-box">
            ...
            <div className="rightbox">
              <div className="rightbox-img">
                <img src="https://i.ibb.co/BsxMMMD/5s-sideimg.webp" />
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="extra-large-container-box">
              <div className="container-subbox">
                <div className="container-img">
                  <a href="">
                    <img src="https://i.ibb.co/MZ2g5cd/6s-img1.webp" />
                  </a>
                </div>
              ...
              <div className="container-subbox">
                <div className="container-img">
                  <a href="">
                    <img src="https://i.ibb.co/wBNwfJL/6s-img2.webp" />
                  </a>
                </div>
                <div className="container-title">
              ...
              <div className="container-subbox">
                <div className="container-img">
                  <a href="">
                    <img src="https://i.ibb.co/z6wgkX6/6s-img3.webp" />
                  </a>
                </div>
                <div className="container-title">
        ...
        <div className="larger-slider-container">
          ...
          <div className="slider-container">
            <a href="">
              <div className="container-box">
                <div className="container-box-img">
                  <img src="https://i.ibb.co/9c8GrZ0/7s-img1.webp" />
                </div>
            ...
            <a href="">
              <div className="container-box">
                <div className="container-box-img">
                  <img src="https://i.ibb.co/rwSqcTv/7s-img2.webp" />
                </div>
                <div className="container-img-title">
                  <p>Wild Hearts™</p>
                </div>
            ...
            <a href="">
              <div className="container-box">
                <div className="container-box-img">
                  <img src="https://i.ibb.co/PgfVZj2/7s-img3.webp" />
                </div>
                <div className="container-img-title">
            ...
            <a href="">
              <div className="container-box">
                <div className="container-box-img">
                  <img src="https://i.ibb.co/b5y2Wgw/7s-img4.webp" />
                </div>
                <div className="container-img-title">
            ...
            <a href="">
              <div className="container-box">
                <div className="container-box-img">
                  <img src="https://i.ibb.co/sJSd4CB/7s-img5.webp" />
                </div>
                <div className="container-img-title">
            ...
            <a href="">
              <div className="container-box">
                <div className="container-box-img">
                  <img src="https://i.ibb.co/SJ9XZ4Z/7s-img6.webp" />
                </div>
                <div className="container-img-title">
                  <p>Elden Ring</p>
                </div>
            ...
            <a href="">
              <div className="container-box">
                <div className="container-box-img">
                  <img src="https://i.ibb.co/yXpWTvP/7s-img7.webp" />
                </div>
                <div className="container-img-title">
            ...
            <a href="">
              <div className="container-box">
                <div className="container-box-img">
                  <img src="https://i.ibb.co/crwQgTC/7s-img8.webp" />
                </div>
                <div className="container-img-title">
            ...
            <a href="">
              <div className="container-box">
                <div className="container-box-img">
                  <img src="https://i.ibb.co/Q69zhmz/7s-img9.webp" />
                </div>
                <div className="container-img-title">
            ...
            <a href="">
              <div className="container-box">
                <div className="container-box-img">
                  <img src="https://i.ibb.co/ckDLhgB/7s-img10.webp" />
                </div>
                <div className="container-img-title">
                  <p>Overwatch 2</p>
                </div>
            ...
            <a href="">
              <div className="container-box">
                <div className="container-box-img">
                  <img src="https://i.ibb.co/mzKZwqd/7s-img11.webp" />
                </div>
                <div className="container-img-title">
                  <p>Dead space</p>
                </div>
            ...
            <a href="">
              <div className="container-box">
                <div className="container-box-img">
                  <img src="https://i.ibb.co/tbsPjph/7s-img12.webp" />
                </div>
                <div className="container-img-title">
                  <p>Gran Turismo 7</p>
                </div>
      ...
      <div className="eight-store-template">
        <div className="eight-store-container">
          ...
          <div className="eight-store-container-sidecontend">
            <a href="">
              <img src="https://i.ibb.co/qJ2P8RD/8s-imgbg.webp" />
            </a>
          </div>
        </div>
      </div>
            ...
            <div className="product-container-box">
              <div className="product-content">
                <div className="product-logo">
                  <img src="https://i.ibb.co/nzChGHY/9simglogo.webp" />
                </div>
              ...
              <div className="product-main-box">
                <div className="product-box">
                  <div className="product-img">
                    <img src="https://i.ibb.co/1v75hnB/9s-img1.webp" />
                  </div>
                ...
                <div className="product-box">
                  <div className="product-img">
                    <img src="https://i.ibb.co/HdcRHyj/9s-img2.webp" />
                  </div>
                  <div className="productname">
                ...
                <div className="product-box">
                  <div className="product-img">
                    <img src="https://i.ibb.co/vmJqMs8/9s-img3.webp" />
                  </div>
                  <div className="productname">
                ...
                <div className="product-box">
                  <div className="product-img">
                    <img src="https://i.ibb.co/3RZHtyc/9s-img4.webp" />
                  </div>
                  <div className="productname">
          ...
          <div className="socialmedia-container">
            ...
            <div className="socialmedia-icon">
              <div className="social-img">
                <a href="https://twitter.com/PlayStationIN" target="_blank">
                  <img
                    src="https://i.ibb.co/Dw6kDvC/socialmedia-img1.webp"/>
                </a>
              </div>
              <div className="social-img">
                <a href="https://www.facebook.com/SonyPlaystationIndia"target="_blank">
                  <img src="https://i.ibb.co/9ZVhkZk/socialmedia-img2.webp" />
                </a>
              </div>
              <div className="social-img">
                <a href="https://www.instagram.com/playstation/" target="_blank">
                  <img src="https://i.ibb.co/tDk9bRt/socialmedia-img3.webp" />
                </a>
              </div>
              <div className="social-img">
                <a href="https://www.youtube.com/channel/UClcQ90LedRcM_HFR-mZsENg" target="_blank">
                  <img src="https://i.ibb.co/s5BWfN7/socialmedia-img4.webp" />
                </a>
              </div>
            </div>
          </div>
